Тема 2.2 **ПОРЯДОК ПРОЕКТИРОВАНИЯ ИНФОРМАЦИОННЫХ** 
...
|&emsp;2\. Разработка  концепции АС  |<p>2.1. Изучение объекта  </p><p>2.2. Проведение необходимых научно-исследовательских работ  </p><p>2.3. Разработка вариантов концепции АС и выбор варианта концепции АС, удовлетворяющей пользователя  </p><p>2.4. Оформление отчёта о выполненной работе  </p>|
...
|&emsp;5\. Технический проект |<p>5.1. Разработка проектных решений по системе и ее частям; </p><p>5.2. Разработка документации на АИС и ее части; </p><p>5.3. Разработка и оформление документации на поставку комплектующих изделий; </p><p>&emsp;5.4 Разработка заданий на проектирование в смежных частях </p><p>проекта. </p>|
...
- *малые  (мелкие)  проекты*  -  характеризуются  использованием  готовых решений  и,  в  ряде  случаев,  адаптацией  их  под  конкретные  условия 
